            ...
            <div className="col-span-12  grid grid-cols-12">
                ...
                >
                    ...
                    <input
                        ...
                        id="name"
                        className="col-span-12 lg:col-span-6 border-b border-primaryColor bg-transparent text-primaryColor-800 placeholder-primaryColor-500 p-4"
                        type="text"
                        placeholder="Name"
                    />
                    ...
                    {loading ? (
                        ...
                        <div className="w-full col-span-12">
                            <MainButton type="submit">Absenden</MainButton>
                            {/* <button
