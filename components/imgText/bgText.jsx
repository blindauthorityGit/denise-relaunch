...
const BGText = (props) => {
    ...
    return (
        <div
            ...
            className={`w-full container  sm:px-0 md:px-24 xl:px-48 m-auto bg-contain bg-no-repeat bg-center lg:[background-position-x:400px] bg-pos-x xl:gap-24 grid grid-cols-12  ${props.colspan}`}
        >
